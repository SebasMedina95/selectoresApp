...
// To parse this data:
//
//   import { Convert, PaisInterface } from "./file";
//
//   const paisInterface = Convert.toPaisInterface(json);
//
...
export class Convert {
    public static toPaisInterface(json: string): PaisInterface {
        return cast(JSON.parse(json), r("PaisInterface"));
    }

    public static paisInterfaceToJson(value: PaisInterface): string {
        return JSON.stringify(uncast(value, r("PaisInterface")), null, 2);
    }
}
